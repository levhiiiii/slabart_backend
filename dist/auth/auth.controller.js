...
let AuthController = class AuthController {
    ...
    async firebaseAuth(firebaseAuthDto) {
        return this.authService.signInWithFirebase(firebaseAuthDto.firebaseUid, firebaseAuthDto.email, firebaseAuthDto.displayName, firebaseAuthDto.photoUrl);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Sign in with Firebase (Google)' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
