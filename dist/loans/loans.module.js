...
const emi_entity_1 = require("../database/entities/emi.entity");
...
exports.LoansModule = LoansModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([loan_entity_1.LoanEntity, emi_entity_1.EMIEntity]), auth_module_1.AuthModule],
        controllers: [],
        providers: [],
    })
], LoansModule);
